        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <p className="text-gray-400 mb-6 font-light leading-relaxed">
              Transforming the construction industry with cutting-edge AI technology
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a href="#" className="hover:text-white transition-colors duration-200 font-light">
                  About Us
                </a>
              </li>
              <li>
              ...
              <li>
                <a href="/pricing" className="hover:text-white transition-colors duration-200 font-light">
                  Pricing
                </a>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                ...
                <a href="mailto:info@buildai.com" className="hover:text-white transition-colors duration-200 font-light">
                  info@buildai.com
                </a>
              </li>
              <li className="flex items-start">
                ...
                <a href="tel:+1234567890" className="hover:text-white transition-colors duration-200 font-light">
                  +1 (234) 567-890
                </a>
              </li>
              <li className="flex items-start">
        ...
        <div className="border-t border-gray-800 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm font-light mb-4 md:mb-0">
              &copy; {currentYear} BuildAI. All rights reserved.
            </p>
