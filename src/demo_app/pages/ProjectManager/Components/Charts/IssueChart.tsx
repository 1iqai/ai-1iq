...
const IssueChart: React.FC<IssueChartProps> = ({ data, title: _title, onSegmentClick }) => {
  ...
  if (filteredData.length === 0 || total === 0) {
    return (
      <div className="w-full h-full flex items-center justify-center">
        <p className="text-gray-600 dark:text-gray-300 text-sm">No Issue data available.</p>
      </div>
    );
  }
