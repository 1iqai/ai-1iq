...
const CoreField = () => {
  ...
  const fieldCapabilities = [
    ...
    },
    {
      ...
      description:
        "Real-time status changes and instant notifications keep everyone informed and updated.",
    ...
    },
    {
      ...
      description:
        "Track productivity and efficiency in real-time to gain actionable insights into your field operations.",
      icon: <FaChartLine className="text-3xl" />,
    },
    {
      title: "Field Control",
      ...
      description:
        "Manage operations, teams, and equipment directly from the field, ensuring seamless execution.",
      icon: <FaBrain className="text-3xl" />,
    },
    {
      ...
      description:
        "Assign, track, and complete jobs on the go, providing flexibility for your mobile workforce.",
      icon: <FaClipboardCheck className="text-3xl" />,
    },
    {
      ...
      description:
        "Seamless coordination across desktop and mobile devices ensures a unified experience for the entire team.",
      icon: <FaUsers className="text-3xl" />,
    },
  ];
