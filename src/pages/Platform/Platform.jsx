...
const Platform = () => {
  ...
  return (
    <div ref={pageRef} className="app relative w-full overflow-x-hidden">
      ...
      <CommonHeader ref={heroRef} title="1iQ Platform" text="Advanced AI-Powered Analytics" />

      {/* Hero Section - White Background */}
      <section id="hero" className="hero__section relative w-full bg-white py-12 md:py-32">
        <div className="container mx-auto px-8">
          <div className="hero__content text-center max-w-4xl mx-auto">
            ...
            <p className="hero__description text-black/80 text-xl md:text-2xl leading-relaxed font-light mb-12 max-w-3xl mx-auto">
              Harness the power of artificial intelligence and machine learning to transform your construction projects
              into intelligent, self-optimizing operations that predict, adapt, and evolve in real-time.
            </p>
